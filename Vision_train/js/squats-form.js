        ...
        <div id="completionModal" class="modal-overlay">
            <div class="modal-card">
                ...
                <div class="modal-actions">
                    <button type="submit" form="workoutForm" class="btn-primary">💾 Save Workout</button>
                    <button type="button" onclick="resetWorkoutAndClose()" class="btn-secondary">➡️ New Set</button>
                </div>
